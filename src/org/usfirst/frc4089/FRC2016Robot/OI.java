...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("AutoLowBar1", new AutoLowBar1());
        SmartDashboard.putData("DriveToDistance", new DriveToDistance(0));
        SmartDashboard.putData("AlignToVision", new AlignToVision());
        SmartDashboard.putData("CollectorExtend", new CollectorExtend());
        SmartDashboard.putData("CollectorRetract", new CollectorRetract(false));
        SmartDashboard.putData("ShooterRaise", new ShooterRaise());
        SmartDashboard.putData("ShooterLower", new ShooterLower());
        SmartDashboard.putData("PusherManageDrive", new PusherManageDrive());
        SmartDashboard.putData("CollectorWheelIn", new CollectorWheelIn());
        SmartDashboard.putData("CollectorWheelOut", new CollectorWheelOut());
        SmartDashboard.putData("ClimberExtend", new ClimberExtend());
        SmartDashboard.putData("AutoShoot", new AutoShoot());
        SmartDashboard.putData("AutoDriveOverLowObstacle3_4", new AutoDriveOverLowObstacle3_4(false));
        SmartDashboard.putData("PusherGoToAngle", new PusherGoToAngle(0));
