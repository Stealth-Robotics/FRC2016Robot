...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveSlot1", new DriveSlot1());
        SmartDashboard.putData("DriveSlot2", new DriveSlot2());
        SmartDashboard.putData("DriveSlot3", new DriveSlot3());
        SmartDashboard.putData("DriveSlot4", new DriveSlot4());
        SmartDashboard.putData("DriveSlot5", new DriveSlot5());
