 ...
 *
 */
public class CatapultShooter extends Subsystem {
    ...
    private final DoubleSolenoid lPiston = RobotMap.catapultShooterLPiston;
    private final DoubleSolenoid rPiston = RobotMap.catapultShooterRPiston;
