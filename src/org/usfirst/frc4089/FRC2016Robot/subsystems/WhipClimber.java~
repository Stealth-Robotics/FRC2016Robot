 ...
 *
 */
public class WhipClimber extends Subsystem {
    ...
    private final CANTalon winchMotor = RobotMap.whipClimberWinchMotor;
    private final DoubleSolenoid dSLatch = RobotMap.whipClimberDSLatch;
